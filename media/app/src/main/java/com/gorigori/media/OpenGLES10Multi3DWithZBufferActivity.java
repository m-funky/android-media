...
public class OpenGLES10Multi3DWithZBufferActivity extends AppCompatActivity {
    ...
    class GL10RenderSample implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl10, int width, int height) {
            ...
            FloatBuffer floatBuffer = ByteBuffer.allocateDirect(vertices.length * 4)
                    .order(ByteOrder.nativeOrder()).asFloatBuffer();
            floatBuffer.put(vertices);
            floatBuffer.position(0);

           // gl10.glEnableClientState(GL10.GL_VERTEX_ARRAY);
            ((GL11)gl10).glBindBuffer(GL11.GL_ARRAY_BUFFER, mVertices);
            ((GL11)gl10).glBufferData(GL11.GL_ARRAY_BUFFER, floatBuffer.capacity() * 4,
                    floatBuffer, GL11.GL_STATIC_DRAW);

            gl10.glEnableClientState(GL10.GL_VERTEX_ARRAY);
            ((GL11)gl10).glVertexPointer(3, GL10.GL_FLOAT, 0, 0);
            ...
            mIndicesLength = byteBuffer.capacity();
